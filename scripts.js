    ...
    if (postLessonForm) {
        postLessonForm.addEventListener('submit', (event) => {
            ...
            reader.onload = function(e) {
                lessons.push({ title: lessonTitle, description: lessonDescription, file: e.target.result, video: lessonVideo, username, timestamp });
                localStorage.setItem('lessons', JSON.stringify(lessons));
            ...
            if (lessonFile) {
                ...
                lessons.push({ title: lessonTitle, description: lessonDescription, file: null, video: lessonVideo, username, timestamp });
                localStorage.setItem('lessons', JSON.stringify(lessons));
                alert('Lesson posted successfully!');
                postLessonForm.reset();
                loadLessons();
